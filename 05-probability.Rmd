...
In this lesson, we will learn about the classical theory of probability, and how it can be used to construct measures of uncertainy of our estimates, and from there to begin to draw inferences from the sample to the population.
...
So, it seems to me at least that we can use the Poisson distribution to fairly accurately describe the probability of occurance of a given number of total goals scored in a premier league game, for this season at least.
...
So, the above was a bit of show, but what we want is the 'go'. In other words, what could we do with this information?

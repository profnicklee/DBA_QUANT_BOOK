...
In this chapter, I'll demonstrate the basic application of ANOVA on the simple 3-group case of the Ed Sheeran Study, and go from there to introduce some classic 'concerns' with the statistical hypothesis testing methodology.
...
We can investigate this using *Post-Hoc tests*, which compare the difference between each pair of groups.

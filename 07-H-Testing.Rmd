...
We can then look at our estimate of 0.745, and - even better - our confidence interval, to gain some indication of the correlation in the population.
...
Interestingly, here we are given 'stars' for the different levels of significance, so to some extent the software is doing some decision making for you.
